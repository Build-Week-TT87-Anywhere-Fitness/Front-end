      ...
      <div>
        ...
        <body>
          ...
          <div className="dummy-gallery">
            <div className="item">
              <img src={dummy1} className="imgOne" alt="Meet-Your Goals"></img>
              <h3>Meet Your Goals</h3>
              <p class="meet-goals">Excelerate To Greatness. </p>
            </div>
            <div className="item">
              <img src={dummy4} className="imgTwo"alt="Meet Your Goals"></img>
            ...
            <div className="item">
              <img src={dummy3} className="imgThree" alt="Meet Your Goals"></img>
          ...
          <p class="copyright">&copy; 2021 Anywhere Fitness</p>
        </body>
      </div>
    );
  }
